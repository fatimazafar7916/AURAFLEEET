...
function ChannelTabs({ activeChannel, onChannelChange }: { activeChannel: string; onChannelChange: (id: string) => void }) {
  ...
  return (
    <div
      ...
      style={{ scrollbarWidth: 'none', msOverflowStyle: 'none', padding: '12px 12px 0' } as React.CSSProperties}
    >
      {tabs.map(tab => (
        <button
          key={tab.id}
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 px-4 py-3 flex flex-col gap-2.5 overflow-hidden">
        {step >= 1 && (
          <div className="flex items-end gap-2 justify-start msg-in">
            ...
            <div style={{ background: '#3A3A3C', color: 'white', borderRadius: '22px 22px 22px 4px' }}
              className="text-sm max-w-[78%] px-3.5 py-2.5 leading-snug">
              Yo is the Lambo Aventador available May 5?
            </div>
            <span className="text-[10px] self-end mb-0.5" style={{ color: '#6B6B6B' }}>11:47 PM</span>
          </div>
        )}
        {step >= 2 && (
          <div className="flex flex-col items-end gap-0.5 msg-in">
            <div style={{ background: 'linear-gradient(135deg, #DD2A7B, #8134AF)', color: 'white', borderRadius: '22px 22px 4px 22px' }}
              className="text-sm max-w-[78%] px-3.5 py-2.5 leading-snug">
              Yes! May 5 confirmed. $4,800/day with 100 miles included. 1 day or longer?
            </div>
            <span className="text-[10px]" style={{ color: '#6B6B6B' }}>11:47 PM · Aiaura · 4s response</span>
          </div>
        )}
        {step >= 3 && (
          <div className="flex items-end gap-2 justify-start msg-in">
            ...
            <span className="text-[10px] self-end mb-0.5" style={{ color: '#6B6B6B' }}>11:48 PM</span>
          </div>
        )}
        {step >= 4 && (
          <div className="flex flex-col items-end gap-0.5 msg-in">
            ...
            <span className="text-[10px]" style={{ color: '#6B6B6B' }}>11:48 PM · Aiaura · 6s response</span>
          </div>
        )}
        {isTyping && (
          <div className="flex justify-end msg-in">
            <div style={{ background: 'linear-gradient(135deg, #DD2A7B, #8134AF)', color: 'white', borderRadius: '22px 22px 4px 22px' }}
              className="text-sm max-w-[78%] px-3.5 py-2.5">
      ...
      <div className="flex items-center gap-3 px-4 py-3" style={{ borderTop: '1px solid #262626' }}>
        <div className="flex-1 rounded-full px-4 py-2 text-[13px]"
      ...
      {step >= 2 && <div className="px-4 pb-2"><AiauraBadge responseTime="4s" /></div>}
      {step >= 4 && (
...
function IMessageCard({ step, typedText, isTyping }: { step: number; typedText: string; isTyping: boolean }) {
  return (
    <div className="rounded-[18px] overflow-hidden flex flex-col h-full"
      ...
      {/* Header */}
      <div className="flex flex-col items-center py-3 px-4" style={{ borderBottom: '1px solid #E8EAED' }}>
        <div className="w-10 h-10 rounded-full flex items-center justify-center text-white font-bold mb-1"
        ...
        {step >= 1 && (
          <div className="flex flex-col items-start msg-in">
            <div className="text-sm max-w-[78%] px-4 py-2.5 leading-snug"
              style={{ background: '#E9E9EB', color: '#000', borderRadius: '20px 20px 20px 4px' }}>
              How much for Range Rover this weekend?
            </div>
            <span className="text-[10px] mt-0.5 ml-1" style={{ color: '#8E8E93' }}>Sat 9:14 PM</span>
          </div>
        )}
        {step >= 2 && (
          <div className="flex flex-col items-end msg-in">
            <div className="text-sm max-w-[78%] px-4 py-2.5 leading-snug"
              style={{ background: 'linear-gradient(180deg, #4ADE5C, #22C55E)', color: 'white', borderRadius: '20px 20px 4px 20px' }}>
              Range Rover Sport — $1,200/day, weekend rate. Total $3,600. Want to lock it in?
            </div>
            <span className="text-[10px] mt-0.5 mr-1" style={{ color: '#8E8E93' }}>Delivered · Aiaura · 6s response</span>
          </div>
        )}
        {step >= 3 && (
          <div className="flex flex-col items-start msg-in">
            ...
            <span className="text-[10px] mt-0.5 ml-1" style={{ color: '#8E8E93' }}>Sat 9:15 PM</span>
          </div>
        )}
        {step >= 4 && (
          <div className="flex flex-col items-end msg-in">
            ...
            <span className="text-[10px] mt-0.5 mr-1" style={{ color: '#8E8E93' }}>Aiaura · 4s response</span>
          </div>
        )}
        {isTyping && (
          <div className="flex justify-end msg-in">
            <div className="px-4 py-2.5 text-sm text-white"
              style={{ background: 'linear-gradient(180deg, #4ADE5C, #22C55E)', borderRadius: '20px 20px 4px 20px' }}>
              {typedText}<span className="animate-pulse font-bold">|</span>
            </div>
          </div>
        )}
      ...
      {/* Input bar */}
      <div className="flex items-center gap-2 px-4 py-3" style={{ borderTop: '1px solid #E8EAED' }}>
        <div className="flex-1 rounded-full px-4 py-2 text-[13px]"
      ...
      {step >= 2 && <div className="px-4 pb-2"><AiauraBadge responseTime="6s" /></div>}
      {step >= 4 && (
    ...
    >
      ...
      <div className="flex items-center gap-3 px-4 py-3"
        ...
        <div className="flex-1">
          ...
          <div className="text-[11px] flex items-center gap-1" style={{ color: '#8696A0' }}>
            <div className="w-2 h-2 rounded-full" style={{ background: '#25D366' }} />online
          </div>
        </div>
      ...
      <div className="flex-1 px-3 py-3 flex flex-col gap-2">
        ...
        <div className="flex justify-center">
          <span className="text-[11px] px-3 py-1 rounded-full" style={{ background: 'rgba(24,34,41,0.85)', color: '#8696A0' }}>Today</span>
        </div>

        {/* Aiaura text bubble (outgoing) */}
        {step >= 1 && (
          <div className="flex justify-end msg-in">
            <div className="relative text-sm max-w-[82%] px-3 py-2 leading-snug"
              ...
              <div className="text-[10px] mt-1 text-right" style={{ color: '#8696A0' }}>✓✓ 12:00 AM</div>
              {/* tail */}
        ...
        {step >= 2 && (
          <div className="flex justify-start msg-in">
            <div className="relative flex items-center gap-2 px-3 py-2 rounded-lg"
              ...
              <span className="text-[10px]" style={{ color: '#8696A0' }}>0:08</span>
              <span className="text-[10px]" style={{ color: '#8696A0' }}>9:00 AM</span>
            </div>
          </div>
        )}
        ...
        {step >= 3 && (
          <div className="flex justify-end msg-in">
            <div className="relative flex items-center gap-2 px-3 py-2 rounded-lg"
              ...
              <span className="text-[10px]" style={{ color: '#8696A0' }}>0:11</span>
              <span className="text-[10px]" style={{ color: '#8696A0' }}>✓✓ 9:00 AM</span>
              {/* tail */}
              <div style={{ position: 'absolute', bottom: 0, right: -8, width: 0, height: 0, borderLeft: '8px solid #DCF8C6', borderBottom: '8px solid transparent' }} />
            </div>
      ...
      <div className="flex items-center gap-2 px-3 py-2" style={{ background: '#F0F0F0' }}>
        <div className="flex-1 rounded-full px-4 py-2 text-[13px]" style={{ background: '#FFFFFF', color: '#8696A0' }}>
          Type a message
        </div>
      ...
      {step >= 1 && <div className="px-4 pb-2"><AiauraBadge responseTime="6s" /></div>}
      {step >= 3 && (
...
function PhoneCallCard({ step, typedText, isTyping }: { step: number; typedText: string; isTyping: boolean }) {
  return (
    ...
    >
      ...
      {/* Call header */}
      <div className="flex flex-col items-center pt-6 pb-3 px-4 relative z-10">
        <div className="text-[22px] font-semibold text-white mb-1">Mark T.</div>
        <div className="text-[13px] mb-0.5 flex items-center gap-2" style={{ color: '#4ADE5C' }}>
          <div className="w-2 h-2 rounded-full animate-pulse" style={{ background: '#4ADE5C' }} />
          Aiaura Speaking
        </div>
        <div className="text-[13px] italic mb-4" style={{ color: 'rgba(74,222,92,0.7)' }}>Aiaura received in 4s</div>

        {/* 28-bar symmetric waveform */}
        <div className="flex items-center gap-0.5 mb-4" style={{ height: 40 }}>
      ...
      <div className="flex-1 mx-4 mb-3 rounded-xl px-3 py-3 flex flex-col gap-3 relative z-10 overflow-hidden"
        style={{ background: 'rgba(255,255,255,0.05)' }}>
        <div className="text-[10px] font-mono" style={{ color: '#8E8E93' }}>LIVE TRANSCRIPT</div>

        {step >= 1 && (
          <div className="msg-in">
            <div className="text-[10px] font-mono font-semibold mb-1" style={{ color: '#8E8E93' }}>MARK T.</div>
            <div className="text-[12px] leading-snug px-3 py-2 rounded-lg"
        ...
        {step >= 2 && (
          <div className="msg-in">
            <div className="text-[10px] font-mono font-semibold mb-1" style={{ color: '#4ADE5C' }}>AIAURA</div>
            <div className="text-[12px] leading-snug px-3 py-2 rounded-lg"
      ...
      <div className="flex justify-center items-center gap-6 px-6 pb-5 relative z-10">
        {[
          { label: 'mute', icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2"><path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" y1="19" x2="12" y2="23"/><line x1="8" y1="23" x2="16" y2="23"/><line x1="2" y1="2" x2="22" y2="22"/></svg>, bg: 'rgba(255,255,255,0.08)' },
          { label: '',     icon: <svg width="26" height="26" viewBox="0 0 24 24" fill="white"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.81 19.79 19.79 0 01.4 1.13 2 2 0 012 .84h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L6.09 8.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 16.92z"/></svg>, bg: 'rgba(220,38,38,0.6)', size: 52 },
          { label: 'speaker', icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"/></svg>, bg: 'rgba(255,255,255,0.08)' },
        ].map(({ label, icon, bg, size = 38 }) => (
          <div key={label} className="flex flex-col items-center gap-1">
            ...
            {label && <span className="text-[10px]" style={{ color: '#8E8E93' }}>{label}</span>}
          </div>
        ))}
      </div>

      {step >= 2 && <div className="px-4 pb-2 relative z-10"><AiauraBadge responseTime="Live call" /></div>}
      {step >= 4 && (
...
function GmailCard({ step }: { step: number }) {
  ...
  return (
    <div className="rounded-[18px] overflow-hidden flex flex-col h-full"
      style={{ background: '#FFFFFF', boxShadow: '0 8px 32px rgba(0,0,0,0.12)' }}>
      {/* Top bar */}
      <div className="flex items-center gap-3 px-4 py-3" style={{ borderBottom: '1px solid #E8EAED' }}>
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#5F6368" strokeWidth="2">
          <path d="M19 12H5M12 5l-7 7 7 7" />
        </svg>
        <span className="text-base font-bold flex-1 truncate" style={{ color: '#202124', fontSize: 16, fontWeight: 700 }}>
      ...
      <div className="flex-1 px-4 py-3 flex flex-col gap-3 overflow-hidden">
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[11px]" style={{ color: '#5F6368' }}>Today, 8:42 AM</span>
            </div>
        ...
        <div className="pl-12 flex flex-col gap-2">
          {step >= 1 && (
            <p className="text-sm leading-relaxed" style={{ color: '#202124', animation: 'gmailFadeIn 0.5s ease both', animationDelay: '0.1s' }}>
              Hi there,
            </p>
          )}
          {step >= 1 && (
            <p className="text-sm leading-relaxed" style={{ color: '#202124', animation: 'gmailFadeIn 0.5s ease both', animationDelay: '0.4s' }}>
        ...
        {replyOpen ? (
          <div className="p-4">
            ...
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-[11px] font-mono font-semibold" style={{ color: '#10B981', fontFamily: 'ui-monospace, monospace' }}>
                Aiaura · Auto-reply
              </span>
            </div>
            ...
            {!showReplyText ? (
              <div className="flex items-center gap-2">
                <span className="text-sm" style={{ color: '#BDC1C6' }}>Aiaura is typing</span>
              ...
              <div style={{ animation: 'gmailFadeIn 0.4s ease both' }}>
                ...
                <span className="text-[10px] font-mono" style={{ color: '#10B981', fontFamily: 'ui-monospace, monospace' }}>
                  Aiaura · 22s response
                </span>
              </div>
            )}
      ...
      {step >= 2 && <div className="px-4 pb-2"><AiauraBadge responseTime="22s" /></div>}
      {step >= 2 && (
...
function ChannelCard({ channel, onChannelChange }: { channel: (typeof CHANNELS)[0]; onChannelChange: (id: string) => void }) {
  ...
  return (
    <div
      className="channel-card rounded-[28px] overflow-hidden"
      style={{
    ...
    >
      ...
      {/* Mockup viewport */}
      <div style={{ flex: 1, padding: '12px 24px 24px', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
        {/* Fade mask top */}
